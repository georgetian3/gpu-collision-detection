...
__kernel void update_physics(
    ...
    double4 new_velocity = collidable.velocity + gravity * dt;
    double4 new_position = collidable.position + (collidable.velocity + new_velocity) * (0.5 * dt);
